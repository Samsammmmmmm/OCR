...
int main(int argc, char** argv)
{
    ...
    SDL_Surface* detect_ligns = *surface;
    // - Do the processing.
    ...
    gamma_filter(detec_ligns);
    contrast(detec_ligns);
    sobel_filter(detec_ligns);
    otsu_tresholding(detec_ligns);
    save_image(detec_ligns, "ligns.png");
